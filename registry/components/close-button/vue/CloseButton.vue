<template>
    <button class="close-button nq-button-s" @click="emit('click', $event)" @mousedown.prevent>
        <!-- CloseIcon (@nimiq/style close.svg), inlined -->
        <svg class="nq-icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
